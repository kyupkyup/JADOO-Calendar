...
$calendarDates.addEventListener('mousedown', e => {
  ...
  if ($selectedMoveBtn) {
    ...
    $calendarDates.addEventListener('mouseover', mouseOverEvent);
    ...
    const mouseUpEvent = () => {
      ...
      $calendarDates.removeEventListener('mousemove', mouseMoveEventFunction);
      $calendarDates.removeEventListener('mouseover', mouseOverEvent);
